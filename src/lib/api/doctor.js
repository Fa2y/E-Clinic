...
export const doctorAPI = {
    ...
    editMedicalRecord: async (mrid,data)=>{
      ...
      const response = await axios.patch(
        `${SERVER_URL}/api-medical/medical_record/${mrid}/`,data,
        {
          headers: {
            Authorization: `token ${encodeURIComponent(token)}`,
          },
    ...
    editMedicalExam: async (meid,data)=>{
        ...
        try {
      const response = await axios.patch(
        `${SERVER_URL}/api-medical/medical_exam/${meid}/`,data,
        {
          headers: {
            Authorization: `token ${encodeURIComponent(token)}`,
          },
    ...
    createMedicalRecord: async (data)=>{
      ...
      const response = await axios.post(
        `${SERVER_URL}/api-medical/medical_record/`,data,
        {
          headers: {
            Authorization: `token ${encodeURIComponent(token)}`,
          },
    ...
    createMedicalExam: async (data)=>{
        ...
        try {
      const response = await axios.post(
        `${SERVER_URL}/api-medical/medical_exam/`,data,
        {
          headers: {
            Authorization: `token ${encodeURIComponent(token)}`,
          },
