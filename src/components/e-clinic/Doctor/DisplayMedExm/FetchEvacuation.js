...
import image from 'assets/img/evacuation.jpg';
...
export default function FetchEvacuation({ values }) {
        ...
        <GridContainer>
          <GridItem xs={7}>
            <div className={classes.content}>
              ...
              <p align="center">
                <strong>
                  Hospital's name : {values?.evacuation?.hospital}
                </strong>
              </p>
              <p className={classes.text}>{values?.evacuation?.letter}</p>
            </div>
          </GridItem>
          <GridItem xs={5}>
            <CardMedia
