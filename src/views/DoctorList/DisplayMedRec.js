        ...
        <GridContainer>
          <Card>
            ...
            <CardBody>
              ...
              {values?.patient_data?.type !==
                initialState?.patient_data?.type && (
                <>
                  <h2>
                  ...
                  <GridContainer>
                    <GridItem xs={12} sm={12} md={6}>
                      ...
                      ${values?.visual_acuity_with_correction_left}`}
                        value={
                          edited_values?.visual_acuity_with_correction_left
                        }
                        variant="outlined"
                        fullWidth
                        onChange={handleChange}
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                      ...
                      ${values?.visual_acuity_with_correction_right}`}
                        value={
                          edited_values?.visual_acuity_with_correction_right
                        }
                        variant="outlined"
                        fullWidth
                        onChange={handleChange}
                  ...
                  <GridContainer>
                    <GridItem xs={12} sm={12} md={6}>
                      ...
                      ${values?.visual_acuity_without_correction_left}`}
                        value={
                          edited_values?.visual_acuity_without_correction_left
                        }
                        variant="outlined"
                        fullWidth
                        onChange={handleChange}
